            ...
            List {
                ...
                Section {
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        Slider(value: Binding(get: { fx.bass }, set: { fx.bass = $0; player.effectsDidChange() }), in: 0...1)
                ...
                Section("混响") {
                    Picker("混响", selection: Binding(get: { fx.reverbIndex }, set: { fx.reverbIndex = $0; player.effectsDidChange() })) {
