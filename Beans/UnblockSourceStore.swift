...
final class UnblockSourceStore: ObservableObject {
    ...
    static let paidPresetSources: [ThirdPartySource] = [
        ...
        // 免费音源：网易云高品2
        ThirdPartySource(
            id: "music.preset.netease_hires2.v1",
            name: "网易云高品2",
            kind: "custom",
            template: "https://netease-cloud-music-api-tan-omega.vercel.app/song/url/v1?id={id}&level=hires",
            urlPath: "data.0.url",
            headers: [:],
            isPreset: true
        ),
        // 免费音源：QQ高品2
        ThirdPartySource(
            id: "music.preset.qq_hires2.v1",
            name: "QQ高品2",
            kind: "custom",
            template: "https://api.qq.jsososo.com/song/url?id={id}&type=m4a",
            urlPath: "data.0.url",
            headers: [:],
            isPreset: true
        ),
        // 免费音源：咪咕高品2
        ThirdPartySource(
            id: "music.preset.migu_hires2.v1",
            name: "咪咕高品2",
            kind: "custom",
            template: "https://api.migu.jsososo.com/song/url?id={id}&quality=m4a",
            urlPath: "data.0.url",
            headers: [:],
            isPreset: true
        ),
        // 免费音源：酷我高品2
        ThirdPartySource(
            id: "music.preset.kuwo_hires2.v1",
            name: "酷我高品2",
            kind: "custom",
            template: "https://www.kuwo.cn/api/v1/www/music/playUrl?mid={id}&type=flac&httpsStatus=1",
            urlPath: "data.url",
        ...
        // 免费音源：网易云无损3
        ThirdPartySource(
            id: "music.preset.netease_flac3.v1",
            name: "网易云无损3",
            kind: "custom",
            template: "https://netease-cloud-music-api-tan-omega.vercel.app/song/url/v1?id={id}&level=lossless",
            urlPath: "data.0.url",
            headers: [:],
            isPreset: true
        ),
        ...
        // 免费音源：全民解析3
        ThirdPartySource(
            id: "music.preset.universal3.v1",
            name: "全民解析3",
            kind: "custom",
            template: "https://api.injahow.cn/meting/?type=url&server={source}&id={id}&br=320",
            urlPath: "url",
            headers: [:],
            isPreset: true
        ),
