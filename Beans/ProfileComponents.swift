...
struct CacheManagerView: View {
    ...
    @State private var autoClean = UserDefaults.standard.bool(forKey: "beans.cache.autoClean")
    @State private var autoCleanDays = UserDefaults.standard.integer(forKey: "beans.cache.autoCleanDays") > 0 ? UserDefaults.standard.integer(forKey: "beans.cache.autoCleanDays") : 7
                    ...
                    VStack(spacing: 12) {
                        ...
                        HStack {
                            ...
                            Toggle("", isOn: $autoClean)
                                .labelsHidden()
                                .onChange(of: autoClean) { v in
                                    UserDefaults.standard.set(v, forKey: "beans.cache.autoClean")
                                }
                        }
                        if autoClean {
                            HStack {
                                ...
                                .frame(width: 180)
                                .onChange(of: autoCleanDays) { v in
                                    UserDefaults.standard.set(v, forKey: "beans.cache.autoCleanDays")
                                }
                            }
                        }
                        // 清理按钮
