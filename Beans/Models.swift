...
struct Song: Identifiable, Hashable, Codable {
    ...
    let fee: Int
    /// 音乐源同步歌单携带的直链播放地址（存在时直接播放，无需再走平台解析）
    let directURL: URL?
    /// 直链来源名称（用于播放器“来自某音源”提示）
    let directSourceName: String?
    ...
    init(id: Int, name: String, artists: String, album: String, coverURL: URL?, duration: TimeInterval, source: SongSource = .netease, qqMid: String? = nil, qqMediaMid: String? = nil, kugouHash: String? = nil, kugouAlbumAudioId: String? = nil, kugouAlbumId: String? = nil, kugouQualityHashes: [String: String]? = nil, fee: Int = 0, directURL: URL? = nil, directSourceName: String? = nil) {
        ...
        self.directSourceName = directSourceName
    }
    ...
    init?(json: [String: Any]) {
        ...
        directURL = nil
        directSourceName = nil
    }

    private enum CodingKeys: String, CodingKey { case id, name, artists, album, coverURL, duration, source, qqMid, qqMediaMid, kugouHash, kugouAlbumAudioId, kugouAlbumId, kugouQualityHashes, fee, directURL, directSourceName }
    ...
    init(from decoder: Decoder) throws {
        ...
        directURL = try c.decodeIfPresent(URL.self, forKey: .directURL)
        directSourceName = try c.decodeIfPresent(String.self, forKey: .directSourceName)
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try c.encodeIfPresent(directURL, forKey: .directURL)
        try c.encodeIfPresent(directSourceName, forKey: .directSourceName)
    }
}
