...
enum BeansAccent: String, CaseIterable, Identifiable {
    ...
    var gradientColors: [Color] {
        ...
        case .sky:
            return [Color(red: 0.45, green: 0.83, blue: 0.99), Color(red: 0.20, green: 0.56, blue: 0.92)]
        case .violet:
        ...
        case .coral:
            return [Color(red: 1.00, green: 0.55, blue: 0.38), Color(red: 0.92, green: 0.30, blue: 0.22)]
        case .ocean:
            return [Color(red: 0.20, green: 0.62, blue: 0.92), Color(red: 0.05, green: 0.32, blue: 0.66)]
        case .lavender:
            return [Color(red: 0.72, green: 0.68, blue: 0.95), Color(red: 0.55, green: 0.42, blue: 0.87)]
        case .rose:
            return [Color(red: 0.93, green: 0.66, blue: 0.62), Color(red: 0.78, green: 0.45, blue: 0.48)]
        case .sunset:
            return [Color(red: 1.00, green: 0.46, blue: 0.35), Color(red: 0.85, green: 0.20, blue: 0.48)]
        case .aurora:
            return [Color(red: 0.42, green: 0.92, blue: 0.62), Color(red: 0.15, green: 0.60, blue: 0.78)]
        case .champagne:
            return [Color(red: 0.96, green: 0.85, blue: 0.62), Color(red: 0.75, green: 0.60, blue: 0.32)]
        case .midnight:
            return [Color(red: 0.38, green: 0.50, blue: 0.90), Color(red: 0.12, green: 0.16, blue: 0.45)]
        case .graphite:
            return [Color(red: 0.62, green: 0.64, blue: 0.70), Color(red: 0.32, green: 0.34, blue: 0.40)]
        case .cherry:
            return [Color(red: 0.95, green: 0.30, blue: 0.30), Color(red: 0.68, green: 0.10, blue: 0.18)]
        }
    }
    ...
    var tintLight: UIColor {
        ...
        case .coral: return UIColor(red: 0.82, green: 0.25, blue: 0.16, alpha: 1)     // 深珊瑚橙
        case .ocean: return UIColor(red: 0.05, green: 0.32, blue: 0.64, alpha: 1)     // 深海洋蓝
        case .lavender: return UIColor(red: 0.48, green: 0.36, blue: 0.80, alpha: 1)  // 深薰衣草
        case .rose: return UIColor(red: 0.68, green: 0.38, blue: 0.42, alpha: 1)      // 深玫瑰金
        case .sunset: return UIColor(red: 0.80, green: 0.18, blue: 0.42, alpha: 1)    // 深夕阳红
        case .aurora: return UIColor(red: 0.10, green: 0.52, blue: 0.68, alpha: 1)    // 深极光绿
        case .champagne: return UIColor(red: 0.62, green: 0.48, blue: 0.22, alpha: 1) // 深香槟金
        case .midnight: return UIColor(red: 0.14, green: 0.18, blue: 0.48, alpha: 1)  // 深午夜蓝
        case .graphite: return UIColor(red: 0.30, green: 0.32, blue: 0.38, alpha: 1)  // 深空灰
        case .cherry: return UIColor(red: 0.62, green: 0.09, blue: 0.16, alpha: 1)    // 深樱桃红
        }
    }
    ...
    var tintDark: UIColor {
        ...
        case .coral: return UIColor(red: 1.00, green: 0.62, blue: 0.45, alpha: 1)
        case .ocean: return UIColor(red: 0.38, green: 0.70, blue: 0.96, alpha: 1)
        case .lavender: return UIColor(red: 0.76, green: 0.72, blue: 0.97, alpha: 1)
        case .rose: return UIColor(red: 0.96, green: 0.74, blue: 0.70, alpha: 1)
        case .sunset: return UIColor(red: 1.00, green: 0.55, blue: 0.45, alpha: 1)
        case .aurora: return UIColor(red: 0.50, green: 0.94, blue: 0.72, alpha: 1)
        case .champagne: return UIColor(red: 0.97, green: 0.88, blue: 0.70, alpha: 1)
        case .midnight: return UIColor(red: 0.55, green: 0.65, blue: 0.95, alpha: 1)
        case .graphite: return UIColor(red: 0.68, green: 0.70, blue: 0.76, alpha: 1)
        case .cherry: return UIColor(red: 0.98, green: 0.45, blue: 0.45, alpha: 1)
        }
    }
}
...
final class ThemeStore: ObservableObject {
    ...
    private init() {
        accent = BeansAccent(rawValue: UserDefaults.standard.string(forKey: AccentTheme.key) ?? "") ?? .sky
