...
enum BeansHaptics {
    ...
    private static var enabled: Bool {
        UserDefaults.standard.bool(forKey: "beans.hapticEnabled")
    }
...
struct BeansGlass<S: Shape>: View {
    ...
    var body: some View {
        // 统一用简单材质，避免 iOS26 GlassEffect 在旧系统上的潜在问题
        switch uiStyle {
        case .compact:
...
// MARK: - 品牌图标（网易云 / QQ / 酷狗统一渲染）
/// 让第三方音乐源图标以「圆角方块 app 图标」的自然质感显示，
/// 避免彩色 logo 直接裸露在玻璃胶囊里显得突兀。
