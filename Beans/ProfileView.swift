        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            if featuresExpanded {
                VStack(spacing: 12) {
                    ...
                    featureCell(icon: "cloud.fill", title: "云端歌曲", subtitle: "Web/网盘识别的音乐 \(CloudSongsStore.shared.songs.count) 首") {
                        showCloudSongs = true
                    }
                    featureCell(icon: "externaldrive.fill", title: "网盘管理", subtitle: "迅雷/夸克/UC 扫码登录") {
                        showCloudDrive = true
                    }
    ...
    private var playbackSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                settingsRow(icon: "externaldrive.fill", title: "网盘管理", subtitle: driveStatusText) {
                    showCloudDrive = true
                }
            }
            .padding(16)
